const bancos = [
    ...
    },
    {
     ...
     function banco(banco){
         document.getElementById('span-banco').innerHTML = is_banco(banco.value)? '<span class="uk-label uk-label-success">'+ b +'</span>' : '<span class="uk-label uk-label-danger">Invalido</span>'
         if(banco.value=='') document.getElementById('span-banco').innerHTML = '';
     }